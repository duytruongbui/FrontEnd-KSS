...
import MainStyles from '../../styles/Menu.module.css';
  ...
  return (
    <>
      ...
      <div className={hideBar}>
        ...
        ></div>
        <div className={MainStyles.backRec1} style={{ zIndex: 10 }}>
      ...
      <div className={`container ${isNoPadding ? 'px-0' : ''}`}>
        <nav className="bg-transparent border-gray-200 py-2.5 rounded md:items-center ">
